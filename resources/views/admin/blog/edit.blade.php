...
<div class="admin-posts-container">
    ...
    <div class="admin-card admin-fade-in">
        <div class="admin-card-header">
            <h2 class="admin-card-title"><i class="fas fa-file-alt me-2"></i>Blog Information</h2>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div id="editor" class="@error('content') quill-error @enderror">{!! old('content', $blog->content) !!}</div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <div class="featured-image-preview mb-2">
                                <img src="{{ asset('storage/' . $blog->featured_image) }}" alt="Current featured image" class="img-fluid rounded">
                            </div>
                            @endif
                        ...
                        <div class="form-group mb-4" id="publish_date_group" style="{{ old('is_published', $blog->is_published) ? 'display: none;' : '' }}">
                        ...
                        <div class="form-group mb-4">
                            <div class="alert alert-info">
                                ...
                                This blog was published on {{ $blog->published_at->format('d M, Y - h:i A') }}
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="admin-card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="blog_highlights" id="blog_highlights"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="contact_info" id="contact_info" rows="3"
                                class="form-control @error('contact_info') is-invalid @enderror">{{ old('contact_info', $blog->contact_info) }}</textarea>
                            @error('contact_info')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
    var quill;
    var initialContent = `{!! old('content', $blog->content) !!}`;
