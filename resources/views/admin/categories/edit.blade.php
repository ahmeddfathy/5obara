        ...
        <div class="col-12">
            <div class="card category-card">
                <div class="category-card-header">
                    <h3 class="category-card-title">Edit Category</h3>
                </div>
                <div class="category-card-body">
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="category-form-group">
                            ...
                            <input type="text" class="category-form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $category->name) }}" required>
                            @error('name')
                        ...
                        <div class="category-form-group">
                            ...
                            <textarea class="category-form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                            <div class="category-invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="category-form-buttons">
                            <button type="submit" class="category-btn category-btn-primary">Update Category</button>
