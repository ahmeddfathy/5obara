...
@section('title', 'إضافة تصنيف فرص استثمارية جديد')
        ...
        <div class="col-12">
            <div class="card category-card">
                <div class="category-card-header">
                    <h3 class="category-card-title">إضافة تصنيف فرص استثمارية جديد</h3>
                </div>
                <div class="category-card-body">
                    <form action="{{ route('admin.investment-categories.store') }}" method="POST">
                        ...
                        <div class="category-form-buttons">
                            <button type="submit" class="category-btn category-btn-primary">إنشاء التصنيف</button>
